...
class HeadHuntCommand(
    ...
    private fun handleStart(
        ...
        val message =
            PREFIX + "HeadHuntイベントを開始しました！ [" + modeLabel + "] 対象: " +
                treasureManager.size + "件" + participationLabel
    ...
    private fun handleList(sender: CommandSender) {
        ...
        for (treasure in treasures) {
            val line =
                "- " + treasure.id + " : " + treasure.worldName +
        ...
        return when (args.size) {
            ...
            3 -> {
                when {
                    ...
                    isAdmin && args[0].equals("team", true) && args[1].lowercase() in listOf("join", "delete") -> {
